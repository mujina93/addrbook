# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in addrbook.
...
base_config.model = addrbook.model
base_config.DBSession = addrbook.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "f354e2b5-f619-49a7-9960-ce8b35da84c4"
