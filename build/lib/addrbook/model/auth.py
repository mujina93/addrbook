...
It's perfectly fine to re-use this definition in the addrbook application,
though.
...
#from addrbook.model.addressbook import users_contacts_table
...
class User(DeclarativeBase):
    ...
    #contacts = relation('Addressbook', secondary=users_contacts_table, backref='users')
